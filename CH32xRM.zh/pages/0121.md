...
<sub>[← p.120](0120.md) · [index](../README.md) · [PDF p.121](https://ch32-riscv-ug.github.io/CH32V103/datasheet_zh/CH32xRM.PDF#page=121) · [p.122 →](0122.md)</sub>

<!-- header: CH32x103应用手册 https://wch.cn -->

图14-3 比较捕获通道的结构框图  
![图14-3](../assets/p121-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V103/datasheet_zh/CH32xRM.PDF#page=121 -->
...
<!-- image: p121-draw-image-00002 inside the figure -->
<!-- image: p121-draw-image-00003 inside the figure -->
TI1 TI1F_Rising  
...
ETRF 0 Output OC1  
enable  
<!-- image: p121-draw-image-00004 inside the figure -->
<!-- image: p121-draw-image-00005 inside the figure -->
‘0’ x0 1 circuit  
OC1REF OC1REFC  
01  
...
controller OC1N_DT  
<!-- image: p121-draw-image-00006 inside the figure -->
<!-- image: p121-draw-image-00007 inside the figure -->
11  
10 0 Output  
...
源可以不只是CH1，见定时器的结构框图14-1），TI1经过滤波器（ICF[3:0]）生成TI1F，再经过边  
