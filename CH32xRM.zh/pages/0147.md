...
<sub>[← p.146](0146.md) · [index](../README.md) · [PDF p.147](https://ch32-riscv-ug.github.io/CH32V103/datasheet_zh/CH32xRM.PDF#page=147) · [p.148 →](0148.md)</sub>
...
1）配置CCxS域，选择ICx信号的来源。比如设为10b，选择TI1FP1作为IC1的来源，不可以使用默  
认设置，CCxS域默认是使比较捕获模块作为输出通道；  
