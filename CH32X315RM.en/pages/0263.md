...
<sub>[← p.262](0262.md) · [index](../README.md) · [PDF p.263](https://ch32-riscv-ug.github.io/CH32X315/datasheet_en/CH32X315RM.PDF#page=263) · [p.264 →](0264.md)</sub>
...
![Figure 17-1](../assets/p263-line-00004.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X315/datasheet_en/CH32X315RM.PDF#page=263 -->


<details><summary>🖼 Text parsed from the figure above</summary>

Address and data bus  
<!-- image: p263-draw-image-00004 inside the figure -->
Read  
Rx buffer  
SPI_CTLR2  
MOSI  
...
Write  
<!-- image: p263-draw-image-00002 inside the figure -->
<!-- image: p263-draw-image-00003 inside the figure -->
0  
Communication  
control  
1  
...
As can be seen from Figure 17-1, the 4 pins related to SPI are MISO, M0SI, SCK and NSS. The MISO pin is the  
...
remains high or low when there is no data. See Figure 17-2 below for details.  
<!-- image: p263-draw-image-00001 bbox=[515.76, 783.48, 535.2, 793.8] -->
<!-- footer: V1.1 261 -->
