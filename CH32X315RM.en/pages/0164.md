...
<sub>[← p.163](0163.md) · [index](../README.md) · [PDF p.164](https://ch32-riscv-ug.github.io/CH32X315/datasheet_en/CH32X315RM.PDF#page=164) · [p.165 →](0165.md)</sub>
...
![Figure 13-2](../assets/p164-line-00003.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X315/datasheet_en/CH32X315RM.PDF#page=164 -->
...
TIM1_SMCR TIM1_SMCR TIM1_SMCR TIM1_SMCR  
...
3) The route from the compare/capture channel pin (TIM1_CHx): TIMx_CHx→TIx→TIxFPx; this route is also  
