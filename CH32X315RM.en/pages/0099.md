...
<sub>[← p.98](0098.md) · [index](../README.md) · [PDF p.99](https://ch32-riscv-ug.github.io/CH32X315/datasheet_en/CH32X315RM.PDF#page=99) · [p.100 →](0100.md)</sub>
...
![Figure 10-1](../assets/p99-line-00004.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X315/datasheet_en/CH32X315RM.PDF#page=99 -->
...
The I/O pins are connected to the onboard peripherals/modules through a multiplexer that allows only one  
peripheral&#x27;s Alternate Function (AF) to be connected to the I/O pin at a time. This ensures that there are no  
