...
<sub>[← p.128](0128.md) · [index](../README.md) · [PDF p.129](https://ch32-riscv-ug.github.io/CH32X315/datasheet_en/CH32X315RM.PDF#page=129) · [p.130 →](0130.md)</sub>
...
![Figure 12-1](../assets/p129-line-00004.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X315/datasheet_en/CH32X315RM.PDF#page=129 -->
...
<em>Note: In the blue dotted box part of the figure, all external input channels of ADC1, ADC2, ADC3 and ADC4 are</em>  
<em>different, and only ADC1 provides the internal reference voltage VREFINT.</em>  
