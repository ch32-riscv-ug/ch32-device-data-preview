...
<sub>[← p.136](0136.md) · [index](../README.md) · [PDF p.137](https://ch32-riscv-ug.github.io/CH32M030/datasheet_en/CH32M030RM.PDF#page=137) · [p.138 →](0138.md)</sub>
...
of the compare capture channel is shown in Figure 10-3.  

Figure 10-3 Block diagram of the structure of the compare capture channel  
![Figure 10-3](../assets/p137-line-00005.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32M030/datasheet_en/CH32M030RM.PDF#page=137 -->
...
see block diagram 10-1 of the timer), TI1 is passed through the filter (ICF[3:0]) to generate TI1F, and then divided  
...
<!-- image: p137-draw-image-00001 bbox=[515.52, 783.36, 535.44, 793.92] -->
<!-- footer: V1.2 142 -->
