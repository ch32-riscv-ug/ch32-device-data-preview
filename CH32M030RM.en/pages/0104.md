...
<sub>[← p.103](0103.md) · [index](../README.md) · [PDF p.104](https://ch32-riscv-ug.github.io/CH32M030/datasheet_en/CH32M030RM.PDF#page=104) · [p.105 →](0105.md)</sub>
...
![Figure 9-2](../assets/p104-line-00003.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32M030/datasheet_en/CH32M030RM.PDF#page=104 -->
...
3) Route from the comparison capture channel pin (TIM1_CHx): TIM1_CHx → TIx → TIxFPx, this route is  
...
<!-- image: p104-draw-image-00001 bbox=[515.52, 783.36, 535.44, 793.92] -->
<!-- footer: V1.2 109 -->
