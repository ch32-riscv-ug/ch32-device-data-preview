...
<sub>[← p.460](0460.md) · [index](../README.md) · [PDF p.461](https://ch32-riscv-ug.github.io/CH32V20x/datasheet_zh/CH32FV2x_V3xRM.PDF#page=461) · [p.462 →](0462.md)</sub>

<!-- header: CH32F/V20x_V30x_V31x系列应用手册 https://wch.cn -->

图27-13 中断示意图  
![图27-13](../assets/p461-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V20x/datasheet_zh/CH32FV2x_V3xRM.PDF#page=461 -->
...
DMA中断是以太网收发器中最重要的中断，一般的用户逻辑中都需要依靠中断接收帧，确认帧  
发送出去，或是及时处理被打断的收发逻辑。  
