...
<sub>[← p.19](0019.md) · [index](../README.md) · [PDF p.20](https://ch32-riscv-ug.github.io/CH32V20x/datasheet_zh/CH32FV2x_V3xRM.PDF#page=20) · [p.21 →](0021.md)</sub>
...
图2-2 POR和PDR的工作示意图  
![图2-2](../assets/p20-line-00012.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V20x/datasheet_zh/CH32FV2x_V3xRM.PDF#page=20 -->
...
4） 读取 PWR_CSR 状态寄存器的 PVDO 位可获取当前系统主电源与 PLS[2:0]设置阈值关系，执行相应  
软处理。当 VDD 电压高于 PLS[2:0]设置阈值，PVDO 位置 0；当 VDD 电压低于 PLS[2:0]设置阈值，  
PVDO位置1。  
<!-- image: p20-draw-image-00001 bbox=[507.6, 786.0, 527.52, 797.04] -->
<!-- footer: V2.5 17 -->
