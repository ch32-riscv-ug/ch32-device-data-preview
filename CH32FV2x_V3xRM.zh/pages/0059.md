...
<sub>[← p.58](0058.md) · [index](../README.md) · [PDF p.59](https://ch32-riscv-ug.github.io/CH32V20x/datasheet_zh/CH32FV2x_V3xRM.PDF#page=59) · [p.60 →](0060.md)</sub>
...
数据寄存器BKP_DATAR1-10、ASOS位、ASOE位在软件配置RCC_BDCTLR寄存器的BDRST位下复位，不  
受RCC外设接口控制BKPRST位影响。  

## 4.3 寄存器描述


<!-- p59-table-001 (table-4-1@1) pages 59-60 -->
