...
<sub>[← p.12](0012.md) · [index](../README.md) · [PDF p.13](https://ch32-riscv-ug.github.io/CH32V20x/datasheet_zh/CH32FV2x_V3xRM.PDF#page=13) · [p.14 →](0014.md)</sub>

<!-- header: CH32F/V20x_V30x_V31x系列应用手册 https://wch.cn -->

图1-9 CH32F20x（连接/互联/大容量通用型）存储映像  
![图1-9](../assets/p13-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V20x/datasheet_zh/CH32FV2x_V3xRM.PDF#page=13 -->
...
0x4001 1000  
0x4001 0C00  
Reserved  Core Private Peripherals  Peripherals Reserved  Reserved  FSMC register  Reserved  FSMC bank2 NAND(NAND1)  Reserved  FSMC bank1 NOR/PSRAM 1  Reserved  Peripherals  Reserved  SRAM (128KBmax)  FLASH  
