...
<sub>[← p.69](0069.md) · [index](../README.md) · [PDF p.70](https://ch32-riscv-ug.github.io/CH32V20x/datasheet_zh/CH32FV2x_V3xRM.PDF#page=70) · [p.71 →](0071.md)</sub>
...
独立看门狗的时钟来源LSI时钟，其功能在停机和待机模式时仍能正常工作。当看门狗计数器自  
减到0时，将会产生系统复位，所以超时时间为（重装载值+1）个时钟。  

图7-1 独立看门狗的结构框图  
![图7-1](../assets/p70-line-00014.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V20x/datasheet_zh/CH32FV2x_V3xRM.PDF#page=70 -->
