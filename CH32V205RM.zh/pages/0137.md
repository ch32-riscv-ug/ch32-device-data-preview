...
<sub>[← p.136](0136.md) · [index](../README.md) · [PDF p.137](https://ch32-riscv-ug.github.io/CH32V205/datasheet_zh/CH32V205RM.PDF#page=137) · [p.138 →](0138.md)</sub>

<!-- header: CH32V205应用手册 https://wch.cn -->

图14-3 比较捕获通道的结构框图  
![图14-3](../assets/p137-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V205/datasheet_zh/CH32V205RM.PDF#page=137 -->
...
来源可以不只是 CH1，见定时器的结构框图 14-1），以 TI1举例：TI1 经过滤波器（ICF[3:0]）生  
