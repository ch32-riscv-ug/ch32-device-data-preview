...
<sub>[← p.378](0378.md) · [index](../README.md) · [PDF p.379](https://ch32-riscv-ug.github.io/CH32V205/datasheet_zh/CH32V205RM.PDF#page=379) · [p.380 →](0380.md)</sub>
...
7）使用32位方式向FLASH地址写入数据，例如：*（uint32_t*）0x80000000 = 0x12345678。  
...
6）设置FLASH_CTLR寄存器的STAT位为‘1’，启动一次快速页擦除（256字节）动作。  
