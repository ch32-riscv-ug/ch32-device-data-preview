...
<sub>[← p.115](0115.md) · [index](../README.md) · [PDF p.116](https://ch32-riscv-ug.github.io/CH32V003/datasheet_en/CH32V003RM.PDF#page=116) · [p.117 →](0117.md)</sub>
...
![Figure 11-3](../assets/p116-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V003/datasheet_en/CH32V003RM.PDF#page=116 -->
...
The complex functions of a general-purpose timer are implemented by manipulating the timer&#x27;s  
compare/capture channel, clock input circuitry, and counter and peripheral components. The clock input to the  
timer can be derived from multiple clock sources including the input to the compare capture channel. The  
<!-- image: p116-draw-image-00001 bbox=[507.6, 794.64, 527.04, 805.2] -->
<!-- footer: V1.9 117 -->
