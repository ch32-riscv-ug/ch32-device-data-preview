...
<sub>[← p.79](0079.md) · [index](../README.md) · [PDF p.80](https://ch32-riscv-ug.github.io/CH32V003/datasheet_en/CH32V003RM.PDF#page=80) · [p.81 →](0081.md)</sub>

<!-- header: CH32V003 Reference Manual https://wch-ic.com -->

> ⬆ **Table continued** — rendered in full at [page 79](0079.md). <!-- p80-table-001 -->

<!-- image: p80-draw-image-00001 bbox=[507.6, 794.64, 527.04, 805.2] -->
<!-- footer: V1.9 81 -->
