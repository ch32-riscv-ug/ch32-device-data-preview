...
<sub>[← p.139](0139.md) · [index](../README.md) · [PDF p.140](https://ch32-riscv-ug.github.io/CH32L103/datasheet_zh/CH32L103RM.PDF#page=140) · [p.141 →](0141.md)</sub>

<!-- header: CH32L103应用手册 https://wch.cn -->

图14-7 门控模式下的控制电路  
![图14-7](../assets/p140-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32L103/datasheet_zh/CH32L103RM.PDF#page=140 -->
...
图14-8 触发模式下的控制电路  
![图14-8](../assets/p140-line-00020.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32L103/datasheet_zh/CH32L103RM.PDF#page=140 -->
...
1) 配置 R16_TIMx_SMCFGR寄存器以配置外部触发输入电路：  
─ETF=0000：没有滤波；  
─ETPS=00：不用预分频器；  
