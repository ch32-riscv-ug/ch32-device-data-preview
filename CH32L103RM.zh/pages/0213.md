...
<sub>[← p.212](0212.md) · [index](../README.md) · [PDF p.213](https://ch32-riscv-ug.github.io/CH32L103/datasheet_zh/CH32L103RM.PDF#page=213) · [p.214 →](0214.md)</sub>
...
### 17.10.5 USART 控制寄存器2（USARTx_CTLR2）（x=1/2/3/4）

偏移地址：0x10  

<!-- p213-table-002 (table-17-5@1) -->
...
> ⬇ **Bit numbers for the register diagram at the top of [page 214](0214.md)**. <!-- p213-line-00053 -->
