...
<sub>[← p.140](0140.md) · [index](../README.md) · [PDF p.141](https://ch32-riscv-ug.github.io/CH32L103/datasheet_zh/CH32L103RM.PDF#page=141) · [p.142 →](0142.md)</sub>
...
![图14-9](../assets/p141-line-00010.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32L103/datasheet_zh/CH32L103RM.PDF#page=141 -->
...
图14-10主/从定时器示例  
![图14-10](../assets/p141-line-00021.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32L103/datasheet_zh/CH32L103RM.PDF#page=141 -->
...
注意：如果选择定时器1的OCx信号作为触发输出(MMS=1xx)，该信号的上升沿将用于驱动定时器2  
