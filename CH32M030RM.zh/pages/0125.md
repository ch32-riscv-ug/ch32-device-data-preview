...
<sub>[← p.124](0124.md) · [index](../README.md) · [PDF p.125](https://ch32-riscv-ug.github.io/CH32M030/datasheet_zh/CH32M030RM.PDF#page=125) · [p.126 →](0126.md)</sub>

<!-- header: CH32M030应用手册 https://wch.cn -->

图10-3 比较捕获通道的结构框图  
![图10-3](../assets/p125-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32M030/datasheet_zh/CH32M030RM.PDF#page=125 -->
...
信号从通道 x 引脚输入进来后可选做为 TIx（TI1 的来源可以不只是 CH1，见定时器的框图 10-  
