...
<sub>[← p.22](0022.md) · [index](../README.md) · [PDF p.23](https://ch32-riscv-ug.github.io/CH32M030/datasheet_zh/CH32M030RM.PDF#page=23) · [p.24 →](0024.md)</sub>
...
处于自由运行状态，无论看门狗功能是否开启，计数器一直循环递减计数。如图4-1所示，窗口看门  
狗内部结构框图。  

图4-1 窗口看门狗结构框图  
![图4-1](../assets/p23-line-00016.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32M030/datasheet_zh/CH32M030RM.PDF#page=23 -->
