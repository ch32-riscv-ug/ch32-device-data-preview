...
<sub>[← p.110](0110.md) · [index](../README.md) · [PDF p.111](https://ch32-riscv-ug.github.io/CH32H417/datasheet_zh/CH32H417DS0.PDF#page=111) · [p.112 →](0112.md)</sub>

<!-- header: CH32H417、H416、H415数据手册 https://wch.cn -->

图3-19 同步总线复用PSRAM写波形  
![图3-19](../assets/p111-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32H417/datasheet_zh/CH32H417DS0.PDF#page=111 -->
...
FSMC_NE  
td(CLKL_N  ADVH  H)  td(CLKL_N  NADVH)  t d(CLKH_AV)  t d(CLKL_AV)  t  d(CLKL_AV)  t d(CLKH_NWEH)  t d(CLKL_ADIV)  t  t d(CLKL_DATA)  Data1  
FSMC_NADV  
FSMC_A[25:16]  
FSMC_NWE  
t h(CLKH_NWAITV)  
