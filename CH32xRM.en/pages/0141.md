...
<sub>[← p.140](0140.md) · [index](../README.md) · [PDF p.141](https://ch32-riscv-ug.github.io/CH32V103/datasheet_en/CH32xRM.PDF#page=141) · [p.142 →](0142.md)</sub>

<!-- header: CH32x103 Reference Manual https://wch-ic.com -->

Figure 14-3 Strucutre block diagram of compare/capture channel  
![Figure 14-3](../assets/p141-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V103/datasheet_en/CH32xRM.PDF#page=141 -->
...
<!-- image: p141-draw-image-00002 inside the figure -->
TI1 TI1F_Rising  
...
ETRF 0 Output OC1  
enable  
<!-- image: p141-draw-image-00003 inside the figure -->
‘0’ x0 1 circuit  
OC1REF OC1REFC  
01  
...
controller OC1N_DT  
<!-- image: p141-draw-image-00004 inside the figure -->
11  
10 0 Output  
...
block diagram 14-1). TI1 passes through the filter (ICF[3:0]) to generate TI1F, and then is divided into  
TI1F_Rising and TI1F_Falling after passing through the edge detector. These two signals are selected (CC1P)  
<!-- image: p141-draw-image-00001 bbox=[518.88, 779.16, 538.32, 789.84] -->
<!-- footer: V1.9 139 -->
