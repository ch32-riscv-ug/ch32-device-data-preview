...
<sub>[← p.2](0002.md) · [index](../README.md) · [PDF p.3](https://ch32-riscv-ug.github.io/CH32V205/datasheet_en/CH32V205RM.PDF#page=3) · [p.4 →](0004.md)</sub>
...
This series of chips is an industrial-grade general-purpose microcontroller designed based on QingKe RISC-V3B  
core. Components such as the core, arbitration unit, DMA module, and SRAM memory interact via multiple bus  
systems. The system block diagrams are shown in Figures 1-1-1 and 1-1-2.  

Figure 1-1-1 CH32V205 system block diagram  
![Figure 1-1-1](../assets/p3-line-00007.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V205/datasheet_en/CH32V205RM.PDF#page=3 -->
