...
<sub>[← p.387](0387.md) · [index](../README.md) · [PDF p.388](https://ch32-riscv-ug.github.io/CH32V205/datasheet_en/CH32V205RM.PDF#page=388) · [p.389 →](0389.md)</sub>
...
![Figure 25-3](../assets/p388-line-00008.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V205/datasheet_en/CH32V205RM.PDF#page=388 -->
...
receiving FIFO is switched, so as to process the received message more efficiently, see section 25.6 CAN interrupt  
for details.  
...
CAN1_FSCFGR register. Each filter group can be configured as a mask bit or identifier list mode by setting  
individual bits in the CAN1_FMCFGR register. Individual filter groups can be enabled or disabled by setting  
corresponding bits in the CAN1_FWR register. Bits in the CAN1_FAFIFOR register determine which receive  
FIFO stores messages passing through the filter.  
As shown in Table 25-1, in mask bit mode, the two registers are the identifier register and the mask register, which  
...
<!-- p388-table-001 (table-25-1@1) pages 388-389 -->
<table><caption>Table 25-1 32-bit mask bit patterns</caption><tr><th>Identifier register</th><th>CANx_FxR1[31:24]</th><th colspan="2">CANx_FxR1[23:16]</th><th colspan="2">CANx_FxR1[15:8]</th><th colspan="4">CANx_FxR1[7:0]</th></tr><tr><td>Mask bit register</td><td>CANx_FxR2[31:24]</td><td colspan="2">CANx_FxR2[23:16]</td><td colspan="2">CANx_FxR2[15:8]</td><td colspan="4">CANx_FxR2[7:0]</td></tr><tr><td>Mapping</td><td>STID[10:3]</td><td>STID[2:0]</td><td>EXID[17:13]</td><td>EXID[12:5]</td><td colspan="2">EXID[4:0]</td><td>IDE</td><td>RTR</td><td>0</td></tr></table>

<!-- image: p388-draw-image-00001 bbox=[515.88, 783.6, 534.96, 793.8] -->
<!-- footer: V1.2 364 -->
