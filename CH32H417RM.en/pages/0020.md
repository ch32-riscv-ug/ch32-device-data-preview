...
<sub>[← p.19](0019.md) · [index](../README.md) · [PDF p.20](https://ch32-riscv-ug.github.io/CH32H417/datasheet_en/CH32H417RM.PDF#page=20) · [p.21 →](0021.md)</sub>
...
Figure 3-2 Clock tree block diagram (Applies only to chips with a fifth digit of 0 in the lot number)  
![Figure 3-2](../assets/p20-line-00004.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32H417/datasheet_en/CH32H417RM.PDF#page=20 -->
...
LPTIM2  
USBSS  
PLL SYSPLL_SEL to SDMMC/DFSDM/SAI/ECDC  
PLL_CLK  
SW  
...
HSI H /2 B ,/ p 4 re ,… sca / l 5 e 1 r 2 /2,/4 HCLK  
PLLCLK/2  
...
<!-- image: p20-draw-image-00001 bbox=[506.88, 786.36, 526.32, 796.68] -->
<!-- footer: V1.7 18 -->
