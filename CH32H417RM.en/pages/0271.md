...
<sub>[← p.270](0270.md) · [index](../README.md) · [PDF p.271](https://ch32-riscv-ug.github.io/CH32H417/datasheet_en/CH32H417RM.PDF#page=271) · [p.272 →](0272.md)</sub>
...
![Figure 15-3](../assets/p271-line-00003.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32H417/datasheet_en/CH32H417RM.PDF#page=271 -->
...
See Figure 15-1 timer block diagram). Take T1 as example, TI1 passes through the filter (ICF[3:0]) to generate  
TI1F, and then is divided into TI1F_Rising and TI1F_Falling after passing through the edge detector. These 2  
signals are selected (CC1P) to generate TI1FP1, and TI1FP1 and TI2FP1 from channel 2 are sent to CC1S  
...
<!-- image: p271-draw-image-00001 bbox=[511.44, 786.36, 530.88, 796.68] -->
<!-- footer: V1.7 269 -->
