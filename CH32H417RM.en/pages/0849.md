...
<sub>[← p.848](0848.md) · [index](../README.md) · [PDF p.849](https://ch32-riscv-ug.github.io/CH32H417/datasheet_en/CH32H417RM.PDF#page=849) · [p.850 →](0850.md)</sub>

<!-- header: CH32H417 Reference Manual https://wch-ic.com -->

> ⬆ **Table continued** — rendered in full at [page 847](0847.md). <!-- p849-table-001 -->


### 38.4.4 SWPMI Interrupt Flag Clear Register (R32_SWPMI_ICR)

Offset address: 0x10  

<!-- p849-table-002 (table-38-4@1) -->
...
> ⬇ **Bit numbers for the register diagram at the top of [page 850](0850.md)**. <!-- p849-line-00045 -->

<!-- image: p849-draw-image-00001 bbox=[511.44, 786.36, 530.88, 796.68] -->
<!-- footer: V1.7 847 -->
