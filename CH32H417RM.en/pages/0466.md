...
<sub>[← p.465](0465.md) · [index](../README.md) · [PDF p.466](https://ch32-riscv-ug.github.io/CH32H417/datasheet_en/CH32H417RM.PDF#page=466) · [p.467 →](0467.md)</sub>

<!-- header: CH32H417 Reference Manual https://wch-ic.com -->

## 23.2 SPI functional Description


### 23.2.1 Overview


Figure 23-1 SPI structure diagram  
![Figure 23-1](../assets/p466-line-00004.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32H417/datasheet_en/CH32H417RM.PDF#page=466 -->


<details><summary>🖼 Text parsed from the figure above</summary>

Address and data bus  
<!-- image: p466-draw-image-00004 inside the figure -->
Read  
Rx buffer  
SPI_CTLR2  
MOSI  
...
Write  
<!-- image: p466-draw-image-00002 inside the figure -->
<!-- image: p466-draw-image-00003 inside the figure -->
0  
Communication  
control  
1  
...
As can be seen from Figure 23-1, the 4 pins related to SPI are MISO, M0SI, SCK and NSS. The MISO pin is the  
...
actively pulled down when the SPI host sends the output outward, and a hardware error will be generated if  
the NSS pin cannot be successfully pulled down and pulled down, indicating that there are other host devices  
on the main line that are communicating; SSOE If it is not set, it can be used in multi-master mode. If it is  
pulled low, it will be forced into slave mode, and the MSTR bit will be automatically cleared.  
...
<!-- image: p466-draw-image-00001 bbox=[511.44, 786.36, 530.88, 796.68] -->
<!-- footer: V1.7 464 -->
