...
<sub>[← p.175](0175.md) · [index](../README.md) · [PDF p.176](https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=176) · [p.177 →](0177.md)</sub>

<!-- header: CH32V00X应用手册 https://wch.cn -->

图15-6 从发送器的传送序列图  
![图15-6](../assets/p176-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=176 -->
...
图15-7 从接收器的传送序列图  
![图15-7](../assets/p176-line-00031.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=176 -->
