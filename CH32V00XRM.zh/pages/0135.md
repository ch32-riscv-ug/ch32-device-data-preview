...
<sub>[← p.134](0134.md) · [index](../README.md) · [PDF p.135](https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=135) · [p.136 →](0136.md)</sub>

<!-- header: CH32V00X应用手册 https://wch.cn -->

图12-3 比较捕获通道的结构框图  
![图12-3](../assets/p135-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=135 -->
...
信号从通道 x 引脚输入进来后可选做为 TIx（TI1 的来源可以不只是 CH1，见定时器的框图 12-  
