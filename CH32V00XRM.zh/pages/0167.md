...
<sub>[← p.166](0166.md) · [index](../README.md) · [PDF p.167](https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=167) · [p.168 →](0168.md)</sub>
...
### 14.8.2 USART 数据寄存器（USARTx_DATAR）（x=1/2）
