...
<sub>[← p.107](0107.md) · [index](../README.md) · [PDF p.108](https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=108) · [p.109 →](0109.md)</sub>

<!-- header: CH32V00X应用手册 https://wch.cn -->

图11-3 比较捕获通道的结构框图  
![图11-3](../assets/p108-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=108 -->
...
比较捕获通道的结构框图如图11-3所示。信号从通道x引脚输入进来后可选做为TIx（TI1的来  
源可以不只是 CH1，见定时器的结构框图 11-1），TI1 经过滤波器（ICF[3:0]）生成 TI1F，再经过边  
