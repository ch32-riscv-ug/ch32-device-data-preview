...
<sub>[← p.132](0132.md) · [index](../README.md) · [PDF p.133](https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=133) · [p.134 →](0134.md)</sub>

<!-- header: CH32V00X应用手册 https://wch.cn -->
道都拥有一组比较捕获寄存器（CHxCVR），支持与主计数器（CNT）进行比较而输出脉冲。  

### 12.2.2 通用定时器和高级定时器的区别
...
图12-2 通用定时器CK_PSC来源框图  
![图12-2](../assets/p133-line-00010.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=133 -->
