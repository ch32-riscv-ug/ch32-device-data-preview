...
<sub>[← p.105](0105.md) · [index](../README.md) · [PDF p.106](https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=106) · [p.107 →](0107.md)</sub>

<!-- header: CH32V00X应用手册 https://wch.cn -->

图11-2 高级定时器的CK_PSC来源框图  
![图11-2](../assets/p106-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=106 -->
...
2） 内部HB时钟输入路线：CK_INT；  
3） 来自比较捕获通道引脚（TIM1_CHx）的路线：TIM1_CHx→TIx→TIxFPx，此路线也用于编码器模  
式；  
4） 来自内部其他定时器的输入：ITRx；  
