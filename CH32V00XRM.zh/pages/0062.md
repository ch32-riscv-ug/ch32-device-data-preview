...
<sub>[← p.61](0061.md) · [index](../README.md) · [PDF p.62](https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=62) · [p.63 →](0063.md)</sub>
...
GPIO引脚上，且外部中断通道的序号必须和GPIO端口的位号一致，比如PA1（或PC1、PD1等）只能  
映射到EXTI1上，且EXTI1只能接受PA1、PC1或PD1等其中之一的映射，两方都是一对一的关系。  
...
图7-2 GPIO模块输入配置结构框图  
![图7-2](../assets/p62-line-00018.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V006/datasheet_zh/CH32V00XRM.PDF#page=62 -->
...
应引脚的电平状态。  
<!-- image: p62-draw-image-00001 bbox=[507.6, 786.0, 527.52, 797.04] -->
<!-- footer: V1.5 51 -->
