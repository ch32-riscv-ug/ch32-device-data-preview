...
<sub>[← p.16](0016.md) · [index](../README.md) · [PDF p.17](https://ch32-riscv-ug.github.io/CH32H417/datasheet_zh/CH32H417RM.PDF#page=17) · [p.18 →](0018.md)</sub>

<!-- header: CH32H417系列应用手册 https://wch.cn -->

图3-3 时钟树框图（适用于批号第五位大于0的芯片）  
![图3-3](../assets/p17-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32H417/datasheet_zh/CH32H417RM.PDF#page=17 -->
...
# HSI是系统内部25MHz的RC振荡器产生的高速时钟信号。HSI RC振荡器能够在不需要任何外部

器件的条件下提供系统时钟。它的启动时间很短但时钟频率精度较差。HSI 通过设置 RCC_CTLR 寄存  
<!-- image: p17-draw-image-00001 bbox=[500.4, 786.24, 520.56, 796.68] -->
<!-- footer: V1.7 13 -->
