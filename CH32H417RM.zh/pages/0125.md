...
<sub>[← p.124](0124.md) · [index](../README.md) · [PDF p.125](https://ch32-riscv-ug.github.io/CH32H417/datasheet_zh/CH32H417RM.PDF#page=125) · [p.126 →](0126.md)</sub>
...
图8-1 窗口看门狗结构框图  
![图8-1](../assets/p125-line-00016.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32H417/datasheet_zh/CH32H417RM.PDF#page=125 -->
...
不能再被关闭，除非发生复位。  
注：可以通过设置RCC_HB1PCENR寄存器关闭WWDG的时钟来源，暂停WWDG_CLK计数，间接停止看门  
狗功能，或者通过设置RCC_HB1PRSTR寄存器复位WWDG模块，等效为复位的作用。  
● 看门狗配置  
...
<!-- image: p125-draw-image-00001 bbox=[504.72, 786.24, 525.24, 796.68] -->
<!-- footer: V1.7 121 -->
