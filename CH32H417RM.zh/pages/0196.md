...
<sub>[← p.195](0195.md) · [index](../README.md) · [PDF p.196](https://ch32-riscv-ug.github.io/CH32H417/datasheet_zh/CH32H417RM.PDF#page=196) · [p.197 →](0197.md)</sub>
...
### 13.3.3 TKEYx数据寄存器（TKEYx_DR）（x=1/2）

偏移地址：0x4C  

<!-- p196-line-00006-bitfield (p196-line-00006-bitfield) -->
...
注：此寄存器映射ADC模块的规则数据寄存器（ADC_RDATAR）。  
<!-- image: p196-draw-image-00001 bbox=[504.72, 786.24, 525.24, 796.68] -->
<!-- footer: V1.7 192 -->
