...
<sub>[← p.364](0364.md) · [index](../README.md) · [PDF p.365](https://ch32-riscv-ug.github.io/CH32H417/datasheet_zh/CH32H417RM.PDF#page=365) · [p.366 →](0366.md)</sub>

<!-- header: CH32H417系列应用手册 https://wch.cn -->

> ⬆ **Table continued** — rendered in full at [page 363](0363.md). <!-- p365-table-001 -->


### 22.4.4 I3C接收数据字节寄存器（R32_I3C_RDR）

偏移地址：0x10  

<!-- p365-table-002 (table-22-6@1) -->
...
<!-- image: p365-draw-image-00001 bbox=[504.72, 786.24, 525.24, 796.68] -->
<!-- footer: V1.7 361 -->
