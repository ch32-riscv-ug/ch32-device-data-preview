...
<sub>[← p.143](0143.md) · [index](../README.md) · [PDF p.144](https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=144) · [p.145 →](0145.md)</sub>

<!-- header: CH32X035系列应用手册 https://wch.cn -->

图13-3 比较捕获通道的结构框图  
![图13-3](../assets/p144-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=144 -->
...
信号从通道x引脚输入进来后可选做为TI（x TI1的来源可以不只是CH1，见定时器的框图12-1），  
...
<!-- image: p144-draw-image-00001 bbox=[507.84, 786.12, 527.28, 796.68] -->
<!-- footer: V1.9 144 -->
