...
<sub>[← p.25](0025.md) · [index](../README.md) · [PDF p.26](https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=26) · [p.27 →](0027.md)</sub>
...
器处于自由运行状态，无论看门狗功能是否开启，计数器一直循环递减计数。如图6-1所示，窗口  
看门狗内部结构框图。  

图6-1 窗口看门狗结构框图  
![图6-1](../assets/p26-line-00016.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=26 -->
