...
<sub>[← p.183](0183.md) · [index](../README.md) · [PDF p.184](https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=184) · [p.185 →](0185.md)</sub>
...
图16-1 SPI结构框图  
![图16-1](../assets/p184-line-00019.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=184 -->


<details><summary>🖼 Text parsed from the figure above</summary>

<strong>Address and data bus</strong>  
<!-- image: p184-draw-image-00004 inside the figure -->
<strong>Read</strong>  
...
<strong>Write</strong>  
<!-- image: p184-draw-image-00002 inside the figure -->
<!-- image: p184-draw-image-00003 inside the figure -->
<strong>0</strong>  
...
由图16-1可以看出，与SPI相关的主要是MISO、M0SI、SCK和NSS四个引脚。其中MISO引脚  
