...
<sub>[← p.119](0119.md) · [index](../README.md) · [PDF p.120](https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=120) · [p.121 →](0121.md)</sub>

<!-- header: CH32X035系列应用手册 https://wch.cn -->
为。  

图12-14 使用定时器1的使能信号触发定时器2  
![图12-14](../assets/p120-line-00003.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=120 -->
...
4) 通过写入MSM=1（R16_TIMx_SMCR寄存器）将定时器1配置为主/从模式。  
...
0 开始计数，但可以通过对任意一个计数器寄存器(R16_TIMx_CNT)进行写操作，在二者之间轻松插  
