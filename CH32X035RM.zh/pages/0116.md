...
<sub>[← p.115](0115.md) · [index](../README.md) · [PDF p.116](https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=116) · [p.117 →](0117.md)</sub>

<!-- header: CH32X035系列应用手册 https://wch.cn -->

图12-7 门控模式下的控制电路  
![图12-7](../assets/p116-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=116 -->
...
图12-8 触发模式下的控制电路  
![图12-8](../assets/p116-line-00020.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=116 -->
...
2) 配置通道1以检测TI的上升沿：  
<!-- image: p116-draw-image-00001 bbox=[507.84, 786.12, 527.28, 796.68] -->
<!-- footer: V1.9 116 -->
