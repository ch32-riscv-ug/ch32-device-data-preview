...
<sub>[← p.31](0031.md) · [index](../README.md) · [PDF p.32](https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=32) · [p.33 →](0033.md)</sub>
...
图7-1 外部中断(EXTI)接口框图  
![图7-1](../assets/p32-line-00004.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X035/datasheet_zh/CH32X035RM.PDF#page=32 -->
...
由图7-1可以看出，外部中断的触发源既可以是软件中断（SWIEVR）也可以是实际的外部中断  
