...
<sub>[← p.212](0212.md) · [index](../README.md) · [PDF p.213](https://ch32-riscv-ug.github.io/CH32V20x/datasheet_en/CH32FV2x_V3xRM.PDF#page=213) · [p.214 →](0214.md)</sub>
...
![Figure 14-2](../assets/p213-line-00003.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V20x/datasheet_en/CH32FV2x_V3xRM.PDF#page=213 -->
...
The actual operation can be divided into 4 categories by determining the input pulse selection of the SMS  
...
TRGI is selected as the source of CK_PSC. It is worth noting that you need to configure TS to select the  
source of TRGI. For TS, the following pulses can be used as the clock sources:  
...
<!-- image: p213-draw-image-00001 bbox=[508.2, 795.0, 527.28, 805.2] -->
<!-- footer: V2.5 208 -->
