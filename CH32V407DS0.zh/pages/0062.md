...
<sub>[← p.61](0061.md) · [index](../README.md) · [PDF p.62](https://ch32-riscv-ug.github.io/CH32V407/datasheet_zh/CH32V407DS0.PDF#page=62) · [p.63 →](0063.md)</sub>

<!-- header: CH32V407、V467数据手册 https://wch.cn -->

图3-17 同步总线复用PSRAM写波形  
![图3-17](../assets/p62-line-00002.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V407/datasheet_zh/CH32V407DS0.PDF#page=62 -->
...
FSMC_NE  
td(CLKL_N  NADVH  H)  td(CLKL_N  NADVH)  t d(CLKH_AV)  t d(CLKL_AV)  t  d(CLKL_AV)  t d(CLKH_NWEH)  t  t d(CLKL_ADIV)  t d(CLKL_DATA)  Data1  
FSMC_NADV  
FSMC_A[23:16]  
FSMC_NWE  
t h(CLKH_NWAITV)  
