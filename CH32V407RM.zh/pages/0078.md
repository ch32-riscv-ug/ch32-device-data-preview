...
<sub>[← p.77](0077.md) · [index](../README.md) · [PDF p.78](https://ch32-riscv-ug.github.io/CH32V407/datasheet_zh/CH32V407RM.PDF#page=78) · [p.79 →](0079.md)</sub>

<!-- header: CH32V407应用手册 https://wch.cn -->

> ⬆ **Table continued** — rendered in full at [page 75](0075.md). <!-- p78-table-001 -->


### 9.4.3 外部中断和事件控制器（EXTI）
...
图9-1 外部中断(EXTI)接口框图  
![图9-1](../assets/p78-line-00008.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32V407/datasheet_zh/CH32V407RM.PDF#page=78 -->
