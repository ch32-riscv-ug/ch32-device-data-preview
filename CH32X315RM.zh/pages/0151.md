...
<sub>[← p.150](0150.md) · [index](../README.md) · [PDF p.151](https://ch32-riscv-ug.github.io/CH32X315/datasheet_zh/CH32X315RM.PDF#page=151) · [p.152 →](0152.md)</sub>
...
0）停止。  
如图13-5，需要在TI2输入引脚上检测到一个上升沿开始，延迟Tdelay之后，在OC1上产生  
一个长度为Tpulse的正脉冲：  

图13-5 单脉冲的产生  
![图13-5](../assets/p151-line-00008.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X315/datasheet_zh/CH32X315RM.PDF#page=151 -->
...
2） Tdelay由比较捕获寄存器的值确定，Tpulse由自动重装值寄存器的值和比较捕获寄存器的值确  
定。  
