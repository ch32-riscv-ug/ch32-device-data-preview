...
<sub>[← p.149](0149.md) · [index](../README.md) · [PDF p.150](https://ch32-riscv-ug.github.io/CH32X315/datasheet_zh/CH32X315RM.PDF#page=150) · [p.151 →](0151.md)</sub>
...
长到R16_TIM1_ATRLR的值而恢复成全0时），OCxREF为低。  
● 中央对齐  
...
如图13-4展示了OCx和OCxN与OCxREF的关系，并展示出死区。  

图13-4 互补输出和死区  
![图13-4](../assets/p150-line-00024.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X315/datasheet_zh/CH32X315RM.PDF#page=150 -->
