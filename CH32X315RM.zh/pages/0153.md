...
<sub>[← p.152](0152.md) · [index](../README.md) · [PDF p.153](https://ch32-riscv-ug.github.io/CH32X315/datasheet_zh/CH32X315RM.PDF#page=153) · [p.154 →](0154.md)</sub>
...
需的任意值。两个定时器都可通过软件使用R16_TIM1_SWEVGR寄存器中的UG位轻松复位。  
