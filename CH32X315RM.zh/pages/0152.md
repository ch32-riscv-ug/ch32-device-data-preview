...
<sub>[← p.151](0151.md) · [index](../README.md) · [PDF p.152](https://ch32-riscv-ug.github.io/CH32X315/datasheet_zh/CH32X315RM.PDF#page=152) · [p.153 →](0153.md)</sub>
...
图13-6 主/从定时器示例  
![图13-6](../assets/p152-line-00004.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X315/datasheet_zh/CH32X315RM.PDF#page=152 -->
...
上溢对应）提供。  
4) 最后必须通过将这两个定时器的相应CEN位（R16_TIM1_CTLR1寄存器）置1同时使能二者。  
...
图13-7 使用定时器1的OC1REF对定时器2实施门控控制  
![图13-7](../assets/p152-line-00039.png) <!-- rendered from the PDF; verify at https://ch32-riscv-ug.github.io/CH32X315/datasheet_zh/CH32X315RM.PDF#page=152 -->
